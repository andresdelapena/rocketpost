...
export function SolutionSection({ onWaitlistClick }: SolutionSectionProps) {
  ...
  return (
    <section id="benefits" className="container max-w-5xl mx-auto px-4 py-24 space-y-12">
      <div className="flex flex-col items-center text-center space-y-8">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl leading-relaxed text-[#1F1F1F]">
              ...
              <CardContent className="p-6 flex flex-col gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-left">
                    <h3 className="font-semibold mb-2 leading-relaxed">{solution.title}</h3>
